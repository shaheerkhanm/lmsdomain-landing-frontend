        ...
        <div className="flex flex-col font-manrope">
            <div className={`px-[0px] !pb-0 pt-[40px] rounded-[20px] overflow-hidden relative ${item.bgColor} `}>
                ...
                <div className="img-div w-full flex justify-center relative z-1">
                    <img src={item?.img} alt="" className='object-cover lg:h-[250px] h-[180px]' />
                </div>
            </div>
            <div className="customer-details py-[15px]">
                <h3 className='2xl:text-[24px] font-bold text-[22px]'>{item.title}</h3>
                <p className='md:text-[18px] text-[16px] lg:w-full w-[90%] leading-tight'>{item.content}</p>
            </div>
        </div>
    )
}
