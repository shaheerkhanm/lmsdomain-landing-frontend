...
function PricingBanner() {
  return (
    <div className='absolute top-0 left-0 -z-1 font-manrope 2xl:h-[90vh] xl:h-[80vh] lg:h-[50vh] bg-gradient-to-b from-[#6C4BFF] to-[#6C4BFF20] w-full flex flex-col items-center justify-center gap-5'>
