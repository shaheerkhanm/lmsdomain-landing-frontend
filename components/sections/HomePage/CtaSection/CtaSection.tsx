  ...
  return (
    <div className='main-padding'>
      <motion.div
        ...
        <h3 className='2xl:text-[52px] xl:text-[45px] lg:text-[38px] md:text-[30px] xsm:text-[24px] text-[20px] text-white font-bold leading-tight text-center'>Ready to Build Your Learning Empire?</h3>
