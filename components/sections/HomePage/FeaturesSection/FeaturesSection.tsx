    ...
    return (
        <div className='main-padding'>
            <div className="grid grid-cols-12 lg:gap-[60px] gap-[10px] lg:gap-y-0 gap-y-10">
                <div className="lg:col-span-6 col-span-12 relative lg:px-0 md:px-10">
                    <div className=" img-div md:p-[20px] p-[15px] sticky top-[30px] rounded-[20px] bg-[#8475C91A]">
                        <motion.img
                            ...
                            src={data?.image || "/assets/img/features/features-img.jpg"} alt={data?.imageAlt} className='w-full md:h-[455px] h-[240px] object-cover md:rounded-[10px] rounded-[10px]' />
                    </div>
                </div>
