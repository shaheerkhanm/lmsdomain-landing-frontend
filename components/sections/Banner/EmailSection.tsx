        ...
        <div className='flex items-center w-[90%]'>
            <form action="" className='w-full'>
                <div className='flex md:flex-row flex-row items-center md:gap-[10px] gap-[5px] justify-center'>
                    <input type="email" placeholder='Enter Your Email' className={`lg:px-6 px-4 lg:py-4 py-3 text-[16px] md:w-[320px] w-full border border-GreyMain rounded-md outline-none ${inputClass}`} />
