  ...
  return (
    <div className='main-padding'>
      <motion.div
        ...
        className="cta-main flex flex-col items-center gap-[20px] bg-[#1B1F3B] rounded-[20px] lg:py-[80px] py-[40px]">
        <h3 className='2xl:text-[52px] xl:text-[45px] lg:text-[38px] md:text-[30px] text-[30px] text-white font-semibold leading-tight text-center'>Ready to Build Your Learning Empire?</h3>
