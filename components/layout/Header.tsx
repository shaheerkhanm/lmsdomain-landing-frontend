...
function Header() {
    ...
    return (
        <div
            className={`fixed md:w-full w-full top-[25px] flex justify-center z-[49] 2xl:px-[240px] xl:px-[80px] md:px-[40px] px-[20px] transition-all duration-500 ease-in-out ${isScrolled ? "!-top-[110px]" : "top-[25px]"
                }`}
        >
